    ...
    <div className="screen">
      ...
      <div className="card" style={{ textAlign: 'center', padding: '20px 18px' }}>
        {/* Avatar — add your photo here later:
            <div style={{ ...same circle styles... }}>
              <img src="/your-photo.jpg" alt="Dr. Ali Altaf" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
        */}
        ...
        <p style={{ fontFamily: "'Newsreader', Georgia, serif", fontSize: 14.5, lineHeight: 1.65, color: 'var(--ink)', marginTop: 14, textAlign: 'left' }}>
          As a doctor, MedConnect was born from my own experience preparing for licensing exams &mdash; long nights of solo revision, scattered resources, and the quiet wish for a partner who got it. I built this app, end to end, from my phone, to give other clinicians the study companion I wanted myself.
        </p>
